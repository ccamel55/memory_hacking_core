...
void Form_Splitter::render() {
	...
	// draw heheh
	UI_RENDER::drawText(_absolutePosition._x, _absolutePosition._y - 2, UI_FONTS::TAB_FONT, UI_COLORS::WHITE, getName());
	UI_RENDER::drawRectFilled(_absolutePosition._x, _absolutePosition._y + 14, _drawSize._x, _drawSize._y, UI_COLORS::CONTROL_FILL_2);
}
