...
void Text_Form::render() {
	...
	if (!(getFlags() & E_UI_FLAGS::UI_INPUT_ONLY)) {
		...
		UI_RENDER::drawText(position._x + UI_FORM::PINNED_OFFSET._x + UI_FORM::CONTENT_POS._x + 8, position._y + (UI_FORM::CONTENT_POS._y / 2), UI_FONTS::WINDOW_FONT, UI_COLORS::FORM_TEXT_LABEL, getName(), E_UI_FONT_FLAGS::UI_FONT_CENTER_Y);
		...
		UI_RENDER::drawText(position._x, position._y, UI_FONTS::TEXT_UI_FONT, UI_COLORS::WHITE, "[  ]", E_UI_FONT_FLAGS::UI_FONT_OUTLINE);
		UI_RENDER::drawText(position._x + 25, position._y, UI_FONTS::TEXT_UI_FONT, UI_COLORS::WHITE, getName(), E_UI_FONT_FLAGS::UI_FONT_OUTLINE);

		if (_expanded) {

			UI_RENDER::drawRectFilled(position._x + 8, position._y + 5, 2, 6, UI_COLORS::GREEN);
			UI_RENDER::drawRect(position._x + 8, position._y + 5, 2, 6, UI_COLORS::BLACK);
		}
		else {

			UI_RENDER::drawRectFilled(position._x + 6, position._y + 7, 6, 2, UI_COLORS::WHITE);
