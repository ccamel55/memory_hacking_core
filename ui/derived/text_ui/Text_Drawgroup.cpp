...
void Text_Drawgroup::render() {
	...
	if (!_controls.empty() && (getFlags() & E_UI_FLAGS::UI_DRAWGROUP_ACTIVE)) {
		...
		UI_RENDER::drawRectFilled(pos._x - 8, pos._y + cursorOffsetY + 1, 3, 13, UI_COLORS::LIGHT_BLUE);
	...
	UI_RENDER::drawText(pos._x + UI_TEXTUI::CONTROL_SPACING._x, pos._y + (UI_TEXTUI::CONTROL_SPACING._y * std::min<size_t>(UI_TEXTUI::DRAWGROUP_ITEM_COUNT, _controls.size())), UI_FONTS::TEXT_UI_FONT, UI_COLORS::LIGHT_BLUE, drawStr, E_UI_FONT_FLAGS::UI_FONT_RIGHT_ALIGN | E_UI_FONT_FLAGS::UI_FONT_OUTLINE);
}
