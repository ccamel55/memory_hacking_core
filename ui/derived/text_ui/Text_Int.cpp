...
void Text_Int::render() {
	...
	// only text lol
	UI_RENDER::drawText(pos._x, pos._y, UI_FONTS::TEXT_UI_FONT, UI_COLORS::WHITE, getName(), E_UI_FONT_FLAGS::UI_FONT_OUTLINE);
	UI_RENDER::drawText(pos._x + UI_TEXTUI::CONTROL_SPACING._x, pos._y, UI_FONTS::TEXT_UI_FONT, _displayText.at(controlIdx)._color, _displayText.at(controlIdx)._name, E_UI_FONT_FLAGS::UI_FONT_RIGHT_ALIGN | E_UI_FONT_FLAGS::UI_FONT_OUTLINE);
